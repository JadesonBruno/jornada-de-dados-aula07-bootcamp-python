...
# Fazendo mesmo exemplo com list comprehension
def filtrarcom_list_comprehension(valores: List[float], limite: float) -> List[float]:
    resultados = [valor for valor in valores if valor > limite]
    return resultados
